...
- `https://tach.cometer/<provider-host>/<path>` 형태로 요청 → 해당 프로바이더로 그대로 패스스루
  - 예: `https://tach.cometer/api.openai.com/v1/responses`
  - 예: `https://tach.cometer/api.anthropic.com/v1/messages`
  - 예: `https://tach.cometer/api.some.provider/api/v1/chat/completions`
...
로컬에서는 `http://localhost:3000/api.openai.com/v1/responses` 처럼 호출.
